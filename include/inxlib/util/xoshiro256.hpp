...
public:
	...
	xoshiro256() : s{}
	{ }
	xoshiro256(std::uniform_random_bit_generator auto& seeder)
	{
		seed(seeder);
	}
	...
	*/
	xoshiro256& jump() {
		constexpr std::array<uint64_t, 4> JUMP{( 0x180ec6d33cfd0aba, 0xd5a61266f0c9392c, 0xa9582618e03fc9aa, 0x39abdc4529b1661c )};
	...
	*/
	xoshiro256& long_jump() {
		constexpr std::array<uint64_t, 4> JUMP{{ 0x76e15d3efefdcbbf, 0xc5004e441c522fb3, 0x77710069854ee241, 0x39109bb02acbe635 }};
